! function(t) {
    ...
    e.prototype.init = function() {
        t("#sa-basic").on("click", function() {
        ...
        }), t("#verification-submit").click(function() {
            Swal.fire({
                title: "Good job!",
                text: "Verification has been automatically accepted, however it may be subject to manual review by a compliance officer and if additional information or clarification is required we will reach out to you from compliance-secure@callanswering.com.  Do NOT reply to any email regarding your identity unless it's from this email address.",
                type: "success",
                confirmButtonClass: "btn btn-confirm mt-2"
            })
            ...
            Swal.fire({
                ...
                text: "You can't proceed untily you add at least one credit card.\nWould you like to add one now?",
                confirmButtonClass: "btn error-btn btn-confirm mt-2",
            })
